...
<html lang="en">
    ...
    <body>
        <div class="welcome">
            ...
            <h1>HELLO!</h1>
            <h2>Todo list</h2>
            <a href="{{ URL::to('add-news') }}">Add News</a><br>
            <a href="{{ URL::to('news') }}">News</a><br>
            <a href="{{ URL::to('heading') }}">Heading</a><br>
            <a href="{{ URL::to('reviews') }}">Reviews</a><br>
            <a href="{{ URL::to('tags') }}">Tags</a><br>
        </div>
    </body>
</html>
