 ...
 */
class Domains extends \App\GrabberBundle\Entity\Domains implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'App\\GrabberBundle\\Entity\\Domains' . "\0" . 'id', '' . "\0" . 'App\\GrabberBundle\\Entity\\Domains' . "\0" . 'domain', '' . "\0" . 'App\\GrabberBundle\\Entity\\Domains' . "\0" . 'token');
        }
